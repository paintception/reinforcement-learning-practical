...
Select actions leveraging their uncertainty: if we are uncertain about the value of an action, we \textcolor{RoyalBlue}{optimistically assume that it is good}.
